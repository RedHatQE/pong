...
--testrun-jenkinsjobs="/path/to/jenkinsjob" \
--testrun-notes="Put any notes about the TestRun here" \
...
optional arguments:
  ...
  --testcase-prefix TESTCASE_PREFIX
                        A string that will be prepended to the autogenerated
                        TestCase title
  --testrun-jenkinsjobs TESTRUN_JENKINSJOBS
                        A URL for the jenkins job build that will be inserted
                        into the {testrun-property:jenkinsjobs} custom field
                        of a TestRun
  --testrun-notes TESTRUN_NOTES
                        A string that will be added to the {testrun-
                        property:notes} custom field of a TestRun
...
testrun_jenkinsjobs:    # A jenkins job build URL to be added to {testrun-property:jenkinsjobs} custom field
testrun_notes:          # A note of any kind to be added to {testrun-property:notes} custom field
```
